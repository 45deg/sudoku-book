"""Generate or verify outputs included by the SMT article."""
...
def generated_outputs() -> dict[str, str]:
    return {
        "07-smt-small-example.txt": run_script("small_example.py"),
        "07-smt-standard.txt": run_script(
            "solve.py", str(ROOT / "fixtures" / "standard-9x9.sdk"), "--limit", "2"
        ),
        "07-smt-unsat.txt": run_script(
            "solve.py", str(ROOT / "fixtures" / "unsat-9x9.sdk"), "--limit", "1"
        ),
        "07-smt-multiple.txt": run_script(
