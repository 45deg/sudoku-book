...
from choice import models  # noqa: E402
from solve import checked_solve  # noqa: E402
from sudoku import boards_are_distinct, load_board, validate_solution  # noqa: E402


class AnswerSetSudokuTest(unittest.TestCase):
    def test_choice_rule_example_has_two_models(self) -> None:
        self.assertEqual(models(), (("drink(tea)",), ("drink(water)",)))
    ...
    def test_standard_board_has_one_solution(self) -> None:
        ...
        result = checked_solve(board, limit=2)
    ...
    def test_multiple_board_returns_two_models(self) -> None:
